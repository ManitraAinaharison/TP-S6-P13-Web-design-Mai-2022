                ...
                <div class="row">
                    ...
                    <div class="card-news">
                        ...
                        <div class="card-content">
                            ...
                            <span class="card-date">Par <?php echo $actu['nom_user'] ?>, le <?php echo $actu['date_ajout'] ?></span>
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li class="page-item <?php if($pagination == 1) echo "disabled" ?>">
      <a class="page-link" href="<?php echo site_url('evenements/page/'.($pagination - 1)) ?>">Previous</a>
    </li>
    <li class="page-item">
      <a class="page-link" href="<?php echo site_url('evenements/page/'.($pagination + 1)) ?>">Next</a>
    </li>
  </ul>
</nav>